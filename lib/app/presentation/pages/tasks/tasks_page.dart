...
class _TasksPageState extends State<TasksPage> {
  ...
  Future<void> _loadChildren() async {
    ...
    try {
      final fetchedChildren = await ResponsibleService().fetchChildren(
        widget.idParaRequests,
      );
      if (!mounted) return;
      setState(() {
    ...
    try {
      ...
      if (widget.userType == TipoUsuario.responsavel) {
        ...
        if (selectedChild != null && selectedChild!.isNotEmpty) {
          final childFound = children.firstWhere(
        ...
        responses = await taskService.fetchTarefasDaCrianca(
          widget.idParaRequests,
        );
      }
      if (!mounted) return;
      setState(() {
        tasks =
            responses.map((t) => _taskResponseToTarefa(t)).where((t) {
      ...
      child: Column(
        children: [
          ...
          Container(
              ...
              .slideX(begin: -0.4, curve: Curves.easeOutBack),
    ...
    return ListView.builder(
      ...
      itemBuilder:
          (context, index) => Padding(
            ...
            child: TaskCard(
              tarefa: tasks[index],
              responsavel: _childInfoToUsuario(
                children.firstWhere(
                  (c) => c.id == tasks[index].responsavelId,
                  orElse:
                      () => ChildInfo(
                        id: 0,
                        idade: 0,
    ...
    return GestureDetector(
      ...
      child: Container(
        decoration: BoxDecoration(
          ...
          border:
              widget.tarefa.situacao == SituacaoTarefa.E
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                ...
                children: [
                  if (!widget.showDetails)
                    GestureDetector(
                        ...
                        .fadeIn(
                          duration: 400.ms,
                          delay: (widget.animationDelay + 200).ms,
                        )
                  ...
                  Row(
                    children: [
                      Text(
                          ...
                          .fadeIn(
                            duration: 400.ms,
                            delay: (widget.animationDelay + 400).ms,
                          )
                          .slideX(begin: 0.5),
                    ],
                  ),
              ...
              if (widget.showDetails &&
                  widget.tarefa.situacao == SituacaoTarefa.C) ...[
                const SizedBox(height: 16),
                Align(
                    ...
                    .fadeIn(
                      duration: 500.ms,
                      delay: (widget.animationDelay + 700).ms,
                    )
                    .scale(
                    ...
                    .shimmer(
                      duration: 1500.ms,
                      delay: (widget.animationDelay + 1200).ms,
                    ),
              ],
                ...
                Row(
                  children: [
                    Icon(
                        ...
                        .fadeIn(
                          duration: 400.ms,
                          delay: (widget.animationDelay + 500).ms,
                        )
                        .scale(begin: const Offset(0, 0)),
                    ...
                    Text(
                        ...
                        .fadeIn(
                          duration: 400.ms,
                          delay: (widget.animationDelay + 600).ms,
                        )
                        .slideX(begin: 0.3),
                  ],
                ),
