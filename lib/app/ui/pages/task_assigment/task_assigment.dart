...
class _TaskAssignmentScreenState extends State<TaskAssignmentScreen> {
  ...
  final List<User> users = [
    ...
    User(name: 'Nome', type: 'Tipo de conta', avatar: 'assets/avatar2.png'),
  ];
          ...
          children: [
            ...
            ElevatedButton(
              onPressed:
                  selectedUser != null
                      ? () {
                        // TODO: Criar tarefa com o usuário selecionado
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _buildBottomNavItem(Icons.menu_book_rounded, false),
            _buildBottomNavItem(Icons.star_rounded, false),
            _buildBottomNavItem(Icons.settings_rounded, false),
          ],
        ),
      ),
    );
