    ...
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (context) => SuccessMessagePage(
          message: 'Tarefa aprovada com sucesso!\nA criança ganhou ${widget.points} pontos.',
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildDetailRow('Status', widget.status, 
                        color: widget.status.toLowerCase() == 'pendente' 
                            ? Colors.orange 
                            : AppColors.primary),
                    ...
                    // Prazo
                    _buildDetailRow('Prazo', widget.deadline),

                    const SizedBox(height: 12),

                    // Tarefa atribuída para
                    _buildDetailRow('Tarefa atribuída para', widget.assignedTo),
